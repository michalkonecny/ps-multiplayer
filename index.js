...
(function($PS) {
  ...
  exports["slowDownRatio"] = slowDownRatio;
 ...
 */  
          ...
          return function (v1) {
              return function (context) {
                  ...
                  var playerStyle = (function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 92, column 3 - line 95, column 26): " + [  ]);
                  })();
                  return function __do() {
      ...
      return function (gstate) {
          return function (v1) {
              if (v1 instanceof CheckCollidedWith) {
                  var m_mvshape = Purlay_MovingShape.bounceOff(v.mvshape)((Purlay_GameObject.unGO(v1.value0)).movingShape);
                  return {
              ...
              var mvshape = function (v2) {
                  if (v2 instanceof FrameTick) {
                      return Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          var $41 = Purlay_MovingPoint.constrainPosWrapAround({
                              minX: 0.0,
                              maxX: Purlay_Examples_TigGame_Global.maxX,
                              minY: 0.0,
                              maxY: Purlay_Examples_TigGame_Global.maxY
                          });
                          var $42 = Purlay_MovingPoint.constrainSpeed({
                              maxSpeed: Purlay_Examples_TigGame_Global.maxSpeed
                          });
                          var $43 = Purlay_MovingPoint.move({
                              slowDownRatio: Purlay_Examples_TigGame_Global.slowDownRatio
                          });
                          return function ($44) {
                              return $41($42($43($44)));
                          };
                  ...
                  if (v2 instanceof PushStart) {
                      return Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          if (v2.value0 instanceof L) {
                              return Purlay_MovingPoint.setAccelX(-Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof R) {
                              return Purlay_MovingPoint.setAccelX(Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof U) {
                              return Purlay_MovingPoint.setAccelY(-Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof D) {
                              return Purlay_MovingPoint.setAccelY(Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 126, column 7 - line 130, column 44): " + [ v2.value0.constructor.name ]);
                      })());
                  };
                  if (v2 instanceof PushStop) {
                      return Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          if (v2.value0 instanceof L) {
                              return Purlay_MovingPoint.resetAccelX(-Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof R) {
                              return Purlay_MovingPoint.resetAccelX(Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof U) {
                              return Purlay_MovingPoint.resetAccelY(-Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          if (v2.value0 instanceof D) {
                              return Purlay_MovingPoint.resetAccelY(Purlay_Examples_TigGame_Global.speedIncrement);
                          };
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 133, column 7 - line 137, column 46): " + [ v2.value0.constructor.name ]);
                      })());
                  };
                  return v.mvshape;
              };
              return {
                  m_object: Data_Maybe.Just.create(fromState({
                      info: v.info,
                      mvshape: mvshape(v1)
                  })),
                  m_gstate: Data_Maybe.Nothing.value
  ...
  var fromState = function (v) {
      return new Purlay_GameObject.GameObject({
          ...
          draw: draw(v),
          encode: Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "playerId";
          }))())(new Data_Symbol.IsSymbol(function () {
              return "name";
  ...
  var fromJson = function (json) {
      return Data_Functor.map(Data_Either.functorEither)(fromState)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          ...
          return "accell";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Purlay_MovingShape.decodeJsonConsistency)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Purlay_MovingShape.decodeJsonShape)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var $$new = function (v) {
      var gameObjectRecord = {
          shape: new Purlay_MovingShape.Ball({
              radius: Purlay_Examples_TigGame_Global.playerRadius
          }),
              ...
              return function (gameObjects) {
                  var findCollision = function ($copy_v) {
                      ...
                      function $tco_loop(v) {
                          ...
                          if (v instanceof Data_List_Types.Cons) {
                              var v1 = (Purlay_GameObject.unGO(object1)).handleAction(gstate)(new Purlay_Examples_TigGame_PlayerPiece.CheckCollidedWith(v.value0.value1));
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 320, column 3 - line 320, column 35): " + [ v.constructor.name ]);
                      };
                      while (!$tco_done) {
                          $tco_result = $tco_loop($copy_v);
                      };
      ...
      var render = function (v) {
          if (v.m_connection instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "wsconnector";
              }))(Data_Ord.ordInt)(_wsconnector)(_wsconnectorN)(Purlay_WSConnector.component)(Data_Unit.unit)(function ($161) {
                  return Data_Maybe.Just.create(FromWSConnector.create($161));
              }))));
          };
          if (v.m_connection instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(FromCoordinator.create($162));
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.br_))(function () {
                      if (v.m_myPiece instanceof Data_Maybe.Nothing) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                              ...
                              valuesSpec: Purlay_Examples_TigGame_Global.tigLobbySpec,
                              my_playerId: v.m_connection.value0.my_peerId
                          })(function ($163) {
                              return Data_Maybe.Just.create(FromLobby.create($163));
                          }));
                      };
                      if (v.m_myPiece instanceof Data_Maybe.Just) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 177, column 7 - line 183, column 98): " + [ v.m_myPiece.constructor.name ]);
                  });
              })));
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 169, column 3 - line 171, column 99): " + [ v.constructor.name ]);
      };
              ...
              if (v.m_connection instanceof Data_Maybe.Just && v.m_myPiece instanceof Data_Maybe.Just) {
                  ...
                  if (v1.m_object instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $80.m_myPiece = new Data_Maybe.Just(v1.m_object.value0);
                          return $80;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(broadcastAction(new SetPlayer(v.m_connection.value0.my_peerId, v1.m_object.value0)))(function () {
                                  var m_collisionResult = getCollision(v.m_connection.value0.my_peerId)(v.gstate)(v1.m_object.value0)(v.otherPieces);
                                  ...
                                  if (m_collisionResult instanceof Data_Maybe.Just) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                          ...
                                          $84.m_myPiece = new Data_Maybe.Just(m_collisionResult.value0.value1);
                                          return $84;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(broadcastAction(new SetPlayer(v.m_connection.value0.my_peerId, m_collisionResult.value0.value1)))(function () {
                                                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v.m_connection.value0.my_peerId === v.gstate.it && v.gstate.itActive)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGState(function (v2) {
                                                      return {
                                                          it: m_collisionResult.value0.value0,
                                                          itActive: v2.itActive
                                                      };
                                                  })))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                                                          return broadcastAction(new SetIt(m_collisionResult.value0.value0));
                                                      });
                                                  }));
                                              });
                                          });
                                  ...
                                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 298, column 13 - line 313, column 57): " + [ m_collisionResult.constructor.name ]);
                              });
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 286, column 9 - line 313, column 57): " + [ v1.m_object.constructor.name ]);
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          });
      };
      var handleAction = function (v) {
          if (v instanceof FromWSConnector) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Random.randomInt(0)(2000000000)))(function (my_peerId) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $102.m_connection = new Data_Maybe.Just({
                          ws: v.value0.value0,
                          my_peerId: my_peerId
                      });
                      return $102;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.m_connection instanceof Data_Maybe.Just) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $109.m_myPiece = new Data_Maybe.Just(playerPiece);
                              return $109;
                          }))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Purlay_HalogenHelpers.periodicEmitter(Effect_Aff_Class.monadAffAff)("FrameTick")(Purlay_Examples_TigGame_Global.tickPeriod_ms)(FrameTick.value))))(function () {
          ...
          if (v instanceof FromCoordinator && v.value0 instanceof Purlay_Coordinator.O_PeersGone) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $121.otherPieces = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Function.flip(Data_Map_Internal["delete"](Data_Ord.ordInt)))(s.otherPieces)(v.value0.value0);
                  return $121;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
          ...
          if (v instanceof FromCoordinator && v.value0 instanceof Purlay_Coordinator.O_StateChanges) {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 219, column 7 - line 221, column 62): " + [ v1.constructor.name ]);
          };
          if (v instanceof SetPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $131 = {};
                  ...
                  $131.otherPieces = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(s.otherPieces);
                  return $131;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      var v1 = (Purlay_GameObject.unGO(v.value1)).info;
                      var values = Data_Map_Internal.singleton("name")(v1.name);
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "lobby";
          ...
          if (v instanceof FrameTick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 264, column 7 - line 278, column 46): " + [ v1.m_connection.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 185, column 18 - line 278, column 46): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (a) {
