...
(function($PS) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                      return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $2 = Data_Functor.map(Data_Maybe.functorMaybe)(downHandler(sid));
                          return function ($3) {
                              return $2(Web_UIEvent_KeyboardEvent.fromEvent($3));
                          };
                      })());
                  }))(function () {
                      return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $4 = Data_Functor.map(Data_Maybe.functorMaybe)(upHandler(sid));
                              return function ($5) {
                                  return $4(Web_UIEvent_KeyboardEvent.fromEvent($5));
                              };
                          })());
                      });
                  });
  ...
  var periodicEmitter = function (dictMonadAff) {
      return function (name) {
          return function (periodMs) {
              return function (action) {
                  return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(periodMs))(function () {
                          return Halogen_Query_EventSource.emit(emitter)(action);
                      }))))(function (fiber) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Effect_Aff.killFiber(Effect_Exception.error("emitter " + (name + ": Event source finalized")))(fiber));
                      });
                  });
              };
          };
  ...
  exports["periodicEmitter"] = periodicEmitter;
...
(function($PS) {
  ...
  var messageToAction = function (msg) {
      ...
      var parseNewPowerMeasurementAndValues = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "power";
          }))()())(new Data_Symbol.IsSymbol(function () {
              return "peerId";
          }))()())())(json))(function (v) {
      ...
      var parseNewPeerOrder = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "peers_order";
          }))()())())(json))(function (v) {
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "my_peerId";
      ...
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.affEventSource(Effect_Aff_Class.monadAffAff)(function (emitter) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(WSListener.setupWSListener(v1.ws)(function (msg) {
                          return Halogen_Query_EventSource.emit(emitter)(new ReceiveMessageFromPeer(msg));
                      })))(function (fiber) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Effect_Aff.killFiber(Effect_Exception.error("websocket: Event source finalized"))(fiber));
                      });
                  }))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Purlay_HalogenHelpers.periodicEmitter(Effect_Aff_Class.monadAffAff)("Pulse")(pulsePeriod_ms)(OutgoingPulse.value))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Purlay_HalogenHelpers.periodicEmitter(Effect_Aff_Class.monadAffAff)("MeasurePower")(checkPowerPeriod_ms)(MeasurePower.value))))(function () {
          ...
          if (v instanceof ReceiveMessageFromPeer) {
              ...
              throw new Error("Failed pattern match at Purlay.Coordinator (line 187, column 7 - line 189, column 44): " + [ v1.constructor.name ]);
          };
          ...
          if (v instanceof OutgoingPulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(broadcastToPeers(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "pulse";
                  }))())())(v1.ws)({
                      pulse: v1.my_peerId
                  })))(function () {
          ...
          if (v instanceof OutgoingStateChanges) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(broadcastToPeers(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "value";
                  }))())(new Data_Symbol.IsSymbol(function () {
                      return "name";
          ...
          throw new Error("Failed pattern match at Purlay.Coordinator (line 145, column 18 - line 245, column 39): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Purlay.Examples.TigGame.GState"] = $PS["Purlay.Examples.TigGame.GState"] || {};
  var exports = $PS["Purlay.Examples.TigGame.GState"];
  var initGState = {
      it: 0
  };
 ...
 */  
  var IsGameObject = function (Drawable1, Jsonable0, gameObjectRecord, updateGameObjectRecordF) {
      this.Drawable1 = Drawable1;
      this.Jsonable0 = Jsonable0;
              ...
              return function (go0) {
                  var aux = function (v) {
                      return function (f) {
                          ...
                          var $107 = Data_Functor.map((dictApplicative.Apply0()).Functor0())(updateGameObjectRecord(dictIsGameObject1)(translateBack));
                          var $108 = updateGameObjectRecord(dictIsGameObject1)(translateThere);
                          return function ($109) {
                              return $107(f($108($109)));
                          };
                      };
                  };
 ...
 */  
  ...
  var drawableAnyGameObject = new Purlay_Drawable.Drawable(function (params) {
      return function (v) {
          return v(function (dictIsGameObject) {
              return Purlay_Drawable.draw(dictIsGameObject.Drawable1())(params);
          });
      };
  });
  ...
  var v3 = -(v2.xyState.pos.y * v2.xyState.velo.y + v2.xyState.pos.x * v2.xyState.velo.x) / (v2.xyState.pos.x * v2.xyState.pos.x + v2.xyState.pos.y * v2.xyState.pos.y);
                          ...
                          throw new Error("Failed pattern match at Purlay.GameObject (line 104, column 3 - line 116, column 26): " + [ v.constructor.name, v1.constructor.name ]);
                      };
                  };
  ...
  var anyGameObject = function (dictIsGameObject) {
      return function (go) {
          return function (v) {
              return v(dictIsGameObject)(go);
          };
      };
  };
  exports["anyGameObject"] = anyGameObject;
  exports["IsGameObject"] = IsGameObject;
  exports["updateXYState"] = updateXYState;
  exports["bounceOff"] = bounceOff;
  exports["drawableAnyGameObject"] = drawableAnyGameObject;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var decodeJsonShape = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      ...
      throw new Error("Failed pattern match at Purlay.GameObjectRecord (line 35, column 5 - line 41, column 20): " + [ v.constructor.name ]);
  });
  var decodeJsonConsistency = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      ...
      throw new Error("Failed pattern match at Purlay.GameObjectRecord (line 52, column 5 - line 55, column 32): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Purlay.JsonHelpers"] = $PS["Purlay.JsonHelpers"] || {};
  var exports = $PS["Purlay.JsonHelpers"];
  var DecodeJsonWithSample = function (decodeJsonWithSample) {
      this.decodeJsonWithSample = decodeJsonWithSample;
  };
  var Jsonable = function (DecodeJsonWithSample1, EncodeJson0) {
      this.DecodeJsonWithSample1 = DecodeJsonWithSample1;
      this.EncodeJson0 = EncodeJson0;
  };
  exports["Jsonable"] = Jsonable;
  exports["DecodeJsonWithSample"] = DecodeJsonWithSample;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var Purlay_JsonHelpers = $PS["Purlay.JsonHelpers"];                
  ...
  var encodeJsonPlayerPiece = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "velo";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "angle";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "accell";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Purlay_GameObjectRecord.encodeJsonConsistency)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Purlay_GameObjectRecord.encodeJsonShape)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "x";
          ...
          return "angleState";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "peerId";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))())(new Data_Symbol.IsSymbol(function () {
  ...
  var drawablePlayerPiece = new Purlay_Drawable.Drawable(function (v) {
      return function (v1) {
          var textSize = Data_Int.round(1.6 * v1.gameObjectRecord.shape.value0.radius);
          var is_me = v1.peerId === v.my_peerId;
          var is_it = v1.peerId === v.gstate.it;
          var playerStyle = (function () {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 85, column 5 - line 88, column 28): " + [  ]);
          })();
          return function __do() {
              Graphics_Canvas.setFillStyle(v.context)(playerStyle)();
              Graphics_Canvas.fillPath(v.context)(Graphics_Canvas.arc(v.context)({
                  start: 0.0,
                  end: 2.0 * $$Math.pi,
                  radius: v1.gameObjectRecord.shape.value0.radius,
                  x: v1.gameObjectRecord.xyState.pos.x,
                  y: v1.gameObjectRecord.xyState.pos.y
              }))();
              Graphics_Canvas.setFillStyle(v.context)("black")();
              Graphics_Canvas.setFont(v.context)(Data_Show.show(Data_Show.showInt)(textSize) + "px sans")();
              Graphics_Canvas.setTextAlign(v.context)(Graphics_Canvas.AlignCenter.value)();
              return Graphics_Canvas.fillText(v.context)(v1.name)(v1.gameObjectRecord.xyState.pos.x)(v1.gameObjectRecord.xyState.pos.y + 0.6 * v1.gameObjectRecord.shape.value0.radius)();
          };
      };
  });
  var decodeJsonPlayerPiece = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var v = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          ...
          return "angleState";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "peerId";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()())(new Data_Symbol.IsSymbol(function () {
      ...
      throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 40, column 5 - line 42, column 27): " + [ v.constructor.name ]);
  });
  var decodeJsonWithSamplePlayerPiece = new Purlay_JsonHelpers.DecodeJsonWithSample(function (v) {
      return Data_Argonaut_Decode_Class.decodeJson(decodeJsonPlayerPiece);
  });
  var jsonablePlayerPiece = new Purlay_JsonHelpers.Jsonable(function () {
      return decodeJsonWithSamplePlayerPiece;
  }, function () {
      return encodeJsonPlayerPiece;
  });
  var isGameObjectPlayerPiece = new Purlay_GameObject.IsGameObject(function () {
      return drawablePlayerPiece;
  }, function () {
      return jsonablePlayerPiece;
  }, function (v) {
      return v.gameObjectRecord;
  }, function (dictApplicative) {
      return function (f) {
          return function (v) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(function ($48) {
                  return PlayerPiece((function (v1) {
                      return {
                          gameObjectRecord: v1,
                          name: v.name,
                          peerId: v.peerId
  ...
  var component = function (dictMonadAff) {
      return function (v) {
              ...
              return function (gstate) {
                  var drawGOs = function (context) {
                      ...
                      return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(function __do() {
                          drawBoard();
                          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableList)(Purlay_Drawable.draw(Purlay_GameObject.drawableAnyGameObject)({
                              my_peerId: v.my_peerId,
                              gstate: gstate,
                              context: context
                          }))(gobjs)();
          ...
          return Halogen_Hooks_Component.component(function (v1) {
              return function (v2) {
                  return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(Data_List_Types.Nil.value))(function (v3) {
                      return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(v.initGState))(function (v4) {
                          return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useQuery(v1.queryToken)(function (v5) {
                              ...
                              return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(drawOnCanvas(v3.value0)(v4.value0))(function () {
                                  return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("canvas"), Halogen_HTML_Properties.width(Data_Int.ceil(v.width)), Halogen_HTML_Properties.height(Data_Int.ceil(v.height)) ]));
                              });
                          });
                      });
                  });
...
(function($PS) {
  ...
  var component = (function () {
      var render = function (v) {
          var enterWSURL = Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.span_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text("Enter broadcast server web-socket URL: ws://")))(function () {
              return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.input(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Properties.value(Data_String_CodePoints.drop(5)(v.urlInput))))(function () {
                  return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Events.onValueChange(function ($15) {
      ...
      var getWSURL = function __do() {
          ...
          var prot = (function () {
              var $8 = host === "game-ws-broadcast.herokuapp.com";
              if ($8) {
                  return "wss://";
              };
              return "ws://";
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.create(v.value0)([  ])))(function (ws) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.delay(100.0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.readyState(ws)))(function (rs) {
                          var $10 = Data_Eq.notEq(Web_Socket_ReadyState.eqReadyState)(rs)(Web_Socket_ReadyState.Open.value);
                          if ($10) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $11 = {};
                                  for (var $12 in st) {
                                  ...
                                  $11.urlInput = v.value0;
                                  $11.maybeMsg = new Data_Maybe.Just("Failed to open web-socket at " + v.value0);
                                  return $11;
                              });
                          };
                          return Halogen_Query_HalogenM.raise(new O_Connected(ws));
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Purlay.WSConnector (line 73, column 18 - line 87, column 35): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var Purlay_Examples_TigGame_GState = $PS["Purlay.Examples.TigGame.GState"];
  ...
  var Web_UIEvent_KeyboardEvent = $PS["Web.UIEvent.KeyboardEvent"];                
  var HandleWSConnector = (function () {
      function HandleWSConnector(value0) {
          this.value0 = value0;
      };
      HandleWSConnector.create = function (value0) {
          return new HandleWSConnector(value0);
      };
      return HandleWSConnector;
  })();
  ...
  var HandleCoordinator = (function () {
      function HandleCoordinator(value0) {
          this.value0 = value0;
      };
      HandleCoordinator.create = function (value0) {
          return new HandleCoordinator(value0);
      };
  ...
  var initialGameState = {
      ...
      gstate: Purlay_Examples_TigGame_GState.initGState,
      itActive: true,
      m_myPiece: Data_Maybe.Nothing.value,
      otherPieces: Data_Map_Internal.empty
  };
  var getCollision = function (peer1) {
      return function (object1) {
          return function (gameObjects) {
              ...
              return removeJust(Data_Foldable.find(Data_List_Types.foldableList)(function (v) {
                  return Data_Maybe.isJust(v.value1);
              })(Data_Map_Internal.toUnfoldable(Data_List_Types.unfoldableList)(Data_Functor.map(Data_Map_Internal.functorMap)(function (go) {
                  return Purlay_GameObject.bounceOff(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece)(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece)(go)(object1);
  ...
  var changesToActions = function (changes) {
      var doOne = function (v) {
          if (v.name === "it") {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 155, column 5 - line 157, column 62): " + [ v1.constructor.name ]);
          };
          var v1 = Data_Argonaut_Decode_Class.decodeJson(Purlay_Examples_TigGame_PlayerPiece.decodeJsonPlayerPiece)(v.value);
          ...
          return Data_Either.Left.create("ignoring change: " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "value";
  ...
  var actionToChanges = function (v) {
      if (v instanceof SetPlayer) {
          return [ {
              ...
              value: Data_Argonaut_Encode_Class.encodeJson(Purlay_Examples_TigGame_PlayerPiece.encodeJsonPlayerPiece)(v.value1)
          } ];
      };
  ...
  var _wsconnectorN = 0;
  var _wsconnector = Data_Symbol.SProxy.value;
  var _lobbyN = 2;
  var _lobby = Data_Symbol.SProxy.value;
  var _coordinatorN = 1;
  var _coordinator = Data_Symbol.SProxy.value;
  var broadcastAction = function (action) {
      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
          return "coordinator";
      }))(Data_Ord.ordInt)(_coordinator)(_coordinatorN)(Halogen_Query.tell(Purlay_Coordinator.Q_StateChanges.create(actionToChanges(action)))));
  };
  var _canvasN = 3;
  ...
  var updateCanvas = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      if (v.m_myPiece instanceof Data_Maybe.Just) {
          var pieces = Data_Functor.map(Data_List_Types.functorList)(Purlay_GameObject.anyGameObject(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece))(Data_List_Types.Cons.create(v.m_myPiece.value0)(Data_Map_Internal.values(v.otherPieces)));
          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
              return "canvas";
          }))(Data_Ord.ordInt)(_canvas)(_canvasN)(Halogen_Query.tell(Purlay_GameCanvas.Q_NewState.create(v.gstate)(pieces))));
      };
      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
  });
  var component = (function () {
      var render = function (v) {
          if (v.m_connection instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "wsconnector";
              }))(Data_Ord.ordInt)(_wsconnector)(_wsconnectorN)(Purlay_WSConnector.component)(Data_Unit.unit)(function ($162) {
                  return Data_Maybe.Just.create(HandleWSConnector.create($162));
              }))));
          };
          if (v.m_connection instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "coordinator";
                  ...
                  return Data_Maybe.Just.create(HandleCoordinator.create($163));
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.br_))(function () {
                      if (v.m_myPiece instanceof Data_Maybe.Nothing) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(_lobbyN)(Purlay_Lobby.component)({
                              valuesSpec: tigLobbySpec,
                              my_playerId: v.m_connection.value0.my_peerId
                          })(function ($164) {
                              return Data_Maybe.Just.create(HandleLobby.create($164));
                          }));
                      };
                      if (v.m_myPiece instanceof Data_Maybe.Just) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                              ...
                              my_peerId: v.m_connection.value0.my_peerId,
                              initGState: Purlay_Examples_TigGame_GState.initGState,
                              width: maxX,
                              height: maxY
                          }))(Data_Unit.unit)(Data_Maybe.Just.create));
                      };
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 232, column 7 - line 238, column 98): " + [ v.m_myPiece.constructor.name ]);
                  });
              })));
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 224, column 3 - line 226, column 101): " + [ v.constructor.name ]);
      };
      var handleMoveBy = function (move) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              if (v.m_connection instanceof Data_Maybe.Just && v.m_myPiece instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $79.m_myPiece = new Data_Maybe.Just(newPlayerPiece);
                      return $79;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(broadcastAction(new SetPlayer(v.m_connection.value0.my_peerId, newPlayerPiece)))(function () {
                              var v1 = getCollision(v.m_connection.value0.my_peerId)(newPlayerPiece)(v.otherPieces);
                              if (v1 instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (v1 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      ...
                                      $83.m_myPiece = new Data_Maybe.Just(v1.value0.value1);
                                      return $83;
                                  }))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                                          return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v.m_connection.value0.my_peerId === v.gstate.it && v.itActive)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGState(function (v2) {
                                              return {
                                                  it: v1.value0.value0
                                              };
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                                                  return broadcastAction(new SetIt(v1.value0.value0));
                                              });
                                          }));
                                      });
                                  });
                              };
                              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 351, column 9 - line 364, column 55): " + [ v1.constructor.name ]);
                          });
                      });
                  });
              };
      ...
      var handleAction = function (v) {
          if (v instanceof HandleWSConnector) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Random.randomInt(0)(2000000000)))(function (my_peerId) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $99.m_connection = new Data_Maybe.Just({
                          ws: v.value0.value0,
                          my_peerId: my_peerId
                      });
                      return $99;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.m_connection instanceof Data_Maybe.Just) {
                          var playerPiece = Purlay_Examples_TigGame_PlayerPiece.newPlayerPiece({
                              peerId: v1.m_connection.value0.my_peerId,
                              xyState: initialMPt(v1.m_connection.value0.my_peerId),
                              name: name,
                              radius: playerRadius
                          });
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $106.m_myPiece = new Data_Maybe.Just(playerPiece);
                              return $106;
                          }))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Purlay_HalogenHelpers.periodicEmitter(Effect_Aff_Class.monadAffAff)("FrameTick")(tickPeriod_ms)(FrameTick.value))))(function () {
                          return Purlay_HalogenHelpers.subscribeToKeyDownUp(Effect_Aff_Class.monadAffAff)(HandleKeyDown.create)(HandleKeyUp.create);
                      });
                  });
              });
          };
          if (v instanceof HandleCoordinator && v.value0 instanceof Purlay_Coordinator.O_NewLeader) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v instanceof HandleCoordinator && v.value0 instanceof Purlay_Coordinator.O_PeerJoined) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v instanceof HandleCoordinator && v.value0 instanceof Purlay_Coordinator.O_PeersGone) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $118 = {};
                  for (var $119 in s) {
                  ...
                  $118.otherPieces = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Function.flip(Data_Map_Internal["delete"](Data_Ord.ordInt)))(s.otherPieces)(v.value0.value0);
                  return $118;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "lobby";
                      }))(Data_Ord.ordInt)(_lobby)(_lobbyN)(Halogen_Query.tell(Purlay_Lobby.Q_ClearPlayers.create(v.value0.value0))));
                  });
              });
          };
          if (v instanceof HandleCoordinator && v.value0 instanceof Purlay_Coordinator.O_StateChanges) {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 275, column 7 - line 277, column 62): " + [ v1.constructor.name ]);
          };
          if (v instanceof SetPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $128 = {};
                  ...
                  $128.otherPieces = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(s.otherPieces);
                  return $128;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      var values = Data_Map_Internal.singleton("name")(v.value1.name);
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "lobby";
                      }))(Data_Ord.ordInt)(_lobby)(_lobbyN)(Halogen_Query.tell(Purlay_Lobby.Q_NewPlayer.create(v.value0)(values))));
                  });
              });
          };
          if (v instanceof SetIt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var $165 = updateGState(function (v1) {
                      return {
                          it: v.value0
                      };
                  });
                  return function ($166) {
                      return $165((function (v1) {
                          return {
                              m_connection: v1.m_connection,
                              gstate: v1.gstate,
                              itActive: false,
                              m_myPiece: v1.m_myPiece,
                              otherPieces: v1.otherPieces
                          };
                      })($166));
                  };
              })()))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if (v1.m_connection instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleMoveBy((function () {
                          var $167 = Purlay_MovingPoint.constrainPosWrapAround({
                              minX: 0.0,
                              maxX: maxX,
                              minY: 0.0,
                              maxY: maxY
                          });
                          var $168 = Purlay_MovingPoint.constrainSpeed({
                              maxSpeed: maxSpeed
                          });
                          var $169 = Purlay_MovingPoint.move({
                              slowDownRatio: slowDownRatio
                          });
                          return function ($170) {
                              return $167($168($169($170)));
                          };
                      })()))(function () {
                  ...
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 319, column 7 - line 336, column 46): " + [ v1.m_connection.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 240, column 18 - line 336, column 46): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (a) {
