...
(function($PS) {
  ...
  var sequenceFunctor = new Data_Functor.Functor(function (f) {
      return function (v) {
  ...
  var sequenceApply = new Control_Apply.Apply(function () {
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["EitherHelpers"] = $PS["EitherHelpers"] || {};
  var exports = $PS["EitherHelpers"];
  var Data_Either = $PS["Data.Either"];                      
  var mapLeft = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at EitherHelpers (line 19, column 1 - line 19, column 65): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var altMergeLefts = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at EitherHelpers (line 23, column 1 - line 23, column 76): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var useQuery = function (token) {
      return function (handler) {
          var handler$prime = function ($15) {
              return handler(Halogen_Hooks_Internal_Types.fromQueryValue($15));
          };
          return Halogen_Hooks_Hook.Hooked(Data_Indexed.Indexed(Control_Monad_Free.liftF(new Halogen_Hooks_Internal_UseHookF.UseQuery(token, handler$prime, Data_Unit.unit))));
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Purlay.Drawable"] = $PS["Purlay.Drawable"] || {};
  var exports = $PS["Purlay.Drawable"];
  var Drawable = function (draw) {
      this.draw = draw;
  };
 ...
 */  
  var IsGameObject = function (gameObjectRecord, updateGameObjectRecordF) {
      this.gameObjectRecord = gameObjectRecord;
      this.updateGameObjectRecordF = updateGameObjectRecordF;
  };

  /**
 * | Working with game objects using their GameObjectRecords: Unary function in an applicative functor 
 */  
  var updateGameObjectRecordF = function (dict) {
      return dict.updateGameObjectRecordF;
  };

  /**
 * | Working with game objects using their GameObjectRecords: Unary function 
 */  
  var updateGameObjectRecord = function (dictIsGameObject) {
      return function (f) {
          return function (go) {
              return updateGameObjectRecordF(dictIsGameObject)(Control_Applicative.applicativeFn)(function (r) {
  ...
  var updateXYState = function (dictIsGameObject) {
      return function (f) {
          return updateGameObjectRecord(dictIsGameObject)(function (r) {
              var $26 = {};
              for (var $27 in r) {
  ...
  var gameObjectRecord = function (dict) {
      return dict.gameObjectRecord;
  };
 ...
 */  
  var relativeTo = function (dictApplicative) {
      return function (dictIsGameObject) {
          return function (dictIsGameObject1) {
              return function (go0) {
                  var aux = function (v) {
                      return function (f) {
                          ...
                          var $98 = Data_Functor.map((dictApplicative.Apply0()).Functor0())(updateGameObjectRecord(dictIsGameObject1)(translateBack));
                          var $99 = updateGameObjectRecord(dictIsGameObject1)(translateThere);
                          return function ($100) {
                              return $98(f($99($100)));
                          };
                      };
                  };
                  return aux(gameObjectRecord(dictIsGameObject)(go0));
              };
          };
      };
  };
 ...
 */  
  var useGameObjects = function (dictIsGameObject) {
      return function (dictIsGameObject1) {
          return function (f) {
              return function (go1) {
                  return function (go2) {
                      return f(gameObjectRecord(dictIsGameObject)(go1))(gameObjectRecord(dictIsGameObject1)(go2));
                  };
              };
          };
      };
  };
  var isTouching = function (dictIsGameObject) {
      return function (dictIsGameObject1) {
          var sqr = function (a) {
              return a * a;
          };
          return useGameObjects(dictIsGameObject)(dictIsGameObject1)(function (v) {
              return function (v1) {
  ...
  var bounceOff = function (dictIsGameObject) {
      return function (dictIsGameObject1) {
          return function (otherObj) {
              return function (obj) {
                  var aux = function (v) {
                      return function (v1) {
                          if (isTouching(dictIsGameObject)(dictIsGameObject1)(otherObj)(obj)) {
  ...
  var v3 = -(v2.xyState.pos.y * v2.xyState.velo.y + v2.xyState.pos.x * v2.xyState.velo.x) / (v2.xyState.pos.x * v2.xyState.pos.x + v2.xyState.pos.y * v2.xyState.pos.y);
                              ...
                              return relativeTo(Data_Maybe.applicativeMaybe)(dictIsGameObject)(dictIsGameObject1)(otherObj)(updateGameObjectRecordF(dictIsGameObject1)(Data_Maybe.applicativeMaybe)(relCollision))(obj);
                          };
                          if (Data_Boolean.otherwise) {
                              return Data_Maybe.Nothing.value;
                          };
                          throw new Error("Failed pattern match at Purlay.GameObject (line 73, column 3 - line 85, column 26): " + [ v.constructor.name, v1.constructor.name ]);
                      };
                  };
                  return aux(gameObjectRecord(dictIsGameObject)(otherObj))(gameObjectRecord(dictIsGameObject1)(obj));
              };
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Purlay.GameObjectRecord"] = $PS["Purlay.GameObjectRecord"] || {};
  var exports = $PS["Purlay.GameObjectRecord"];
  ...
  var eqConsistency = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var encodeJsonShape = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
  ...
  var encodeJsonConsistency = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)("Solid");
  });
  var decodeJsonShape = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var v = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "shape";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "radius";
      }))()())())(json);
      ...
      throw new Error("Failed pattern match at Purlay.GameObjectRecord (line 36, column 5 - line 42, column 20): " + [ v.constructor.name ]);
  });
  var decodeJsonConsistency = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      ...
      throw new Error("Failed pattern match at Purlay.GameObjectRecord (line 53, column 5 - line 56, column 32): " + [ v.constructor.name ]);
  });
  ...
  exports["eqConsistency"] = eqConsistency;
 ...
 */  
  ...
  var $$Math = $PS["Math"];
  var Purlay_Drawable = $PS["Purlay.Drawable"];
  var Purlay_GameObject = $PS["Purlay.GameObject"];
  var Purlay_GameObjectRecord = $PS["Purlay.GameObjectRecord"];                
  var PlayerPiece = function (x) {
      return x;
  };
  var newPlayerPiece = function (v) {
      return {
          shape: new Purlay_GameObjectRecord.Ball({
              radius: v.radius
          }),
          consistency: Purlay_GameObjectRecord.Solid.value,
          scaling: 1.0,
          xyState: v.xyState,
          angleState: Purlay_GameObjectRecord.initMovingAngle,
          name: v.name
      };
  };
  var isGameObjectPlayerPiece = new Purlay_GameObject.IsGameObject(function (v) {
      return v;
  }, function (dictApplicative) {
      return function (f) {
          return function (v) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(PlayerPiece)(f(v));
          };
      };
  });
  var eqPlayerPiece = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.angleState.accell === y.angleState.accell && x.angleState.angle === y.angleState.angle && x.angleState.velo === y.angleState.velo && Data_Eq.eq(Purlay_GameObjectRecord.eqConsistency)(x.consistency)(y.consistency) && x.name === y.name && x.scaling === y.scaling && Data_Eq.eq(Purlay_GameObjectRecord.eqShape)(x.shape)(y.shape) && (x.xyState.accell.x === y.xyState.accell.x && x.xyState.accell.y === y.xyState.accell.y && (x.xyState.pos.x === y.xyState.pos.x && x.xyState.pos.y === y.xyState.pos.y) && (x.xyState.velo.x === y.xyState.velo.x && x.xyState.velo.y === y.xyState.velo.y));
      };
  });
  var encodeJsonPlayerPiece = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "velo";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "angle";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "accell";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Purlay_GameObjectRecord.encodeJsonConsistency)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Purlay_GameObjectRecord.encodeJsonShape)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var drawablePlayerPiece = new Purlay_Drawable.Drawable(function (v) {
      return function (v1) {
          var textSize = Data_Int.round(1.6 * v.shape.value0.radius);
          return function __do() {
              Graphics_Canvas.setFillStyle(v1.context)(v1.style)();
              Graphics_Canvas.fillPath(v1.context)(Graphics_Canvas.arc(v1.context)({
                  start: 0.0,
                  end: 2.0 * $$Math.pi,
                  radius: v.shape.value0.radius,
                  x: v.xyState.pos.x,
                  y: v.xyState.pos.y
              }))();
              Graphics_Canvas.setFillStyle(v1.context)("black")();
              Graphics_Canvas.setFont(v1.context)(Data_Show.show(Data_Show.showInt)(textSize) + "px sans")();
              Graphics_Canvas.setTextAlign(v1.context)(Graphics_Canvas.AlignCenter.value)();
              return Graphics_Canvas.fillText(v1.context)(v.name)(v.xyState.pos.x)(v.xyState.pos.y + 0.6 * v.shape.value0.radius)();
          };
      };
  });
  var decodeJsonPlayerPiece = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var v = Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "velo";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "angle";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "accell";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Purlay_GameObjectRecord.decodeJsonConsistency)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Purlay_GameObjectRecord.decodeJsonShape)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      ...
      throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 34, column 5 - line 36, column 27): " + [ v.constructor.name ]);
  });
  exports["newPlayerPiece"] = newPlayerPiece;
  exports["eqPlayerPiece"] = eqPlayerPiece;
  exports["encodeJsonPlayerPiece"] = encodeJsonPlayerPiece;
  exports["decodeJsonPlayerPiece"] = decodeJsonPlayerPiece;
  exports["isGameObjectPlayerPiece"] = isGameObjectPlayerPiece;
  exports["drawablePlayerPiece"] = drawablePlayerPiece;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var SelectedPlayer = (function () {
      function SelectedPlayer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectedPlayer.create = function (value0) {
          return function (value1) {
              return new SelectedPlayer(value0, value1);
          };
      };
      return SelectedPlayer;
  })();
  var NewPlayer = (function () {
      function NewPlayer(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      NewPlayer.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new NewPlayer(value0, value1, value2);
              };
          };
      };
      return NewPlayer;
  ...
  var ClearPlayers = (function () {
      function ClearPlayers(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ClearPlayers.create = function (value0) {
          return function (value1) {
              return new ClearPlayers(value0, value1);
          };
      };
      return ClearPlayers;
  })();
  ...
  var SelectingPlayer = (function () {
      function SelectingPlayer(value0) {
          this.value0 = value0;
      };
      SelectingPlayer.create = function (value0) {
          return new SelectingPlayer(value0);
      };
  ...
  var updateSelectingPlayer = function (fn) {
      return function (v) {
          if (v instanceof SelectingPlayer) {
              return SelectingPlayer.create(fn(v.value0));
          };
          return v;
      };
  };
  var updateConnecting = function (fn) {
      return function (v) {
          if (v instanceof Connecting) {
              return Connecting.create(fn(v.value0));
          };
          return v;
      };
  };                                          
  var initialState = new Connecting({
  ...
  var component = function (valuesSpec) {
      var render = function (v) {
          if (v instanceof Connecting) {
              var enterWSURL = Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.span_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text("Enter broadcast server web-socket URL: ws://")))(function () {
                  ...
                  return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("error") ])([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(v.value0.maybeMsg)) ]));
              })));
              return Halogen_HTML_Elements.div([  ])([ enterWSURL ]);
          };
          if (v instanceof SelectingPlayer) {
              var playButton = (function () {
                  var player = Data_Maybe.fromMaybe(0)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                      return v1.key;
                  })(Data_Map_Internal.findMax(v.value0.players))) + 1 | 0;
                  return Halogen_HTML_Elements.td_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.button(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Properties.title("Play")))(function () {
                      return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Events.onClick(function (v1) {
                          return new Data_Maybe.Just(new SelectPlayer(player, v.value0.values));
                      }));
              ...
              var chooseValues = (function () {
                  var playersArray = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray)(v.value0.players);
                  ...
                  return Halogen_HTML_Elements.table([ Halogen_HTML_Properties.class_("lobby-values") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ headerRow ])(Data_Functor.map(Data_Functor.functorArray)(makeRow)(valuesSpec)));
              })();
          ...
          throw new Error("Failed pattern match at Purlay.Lobby (line 107, column 3 - line 118, column 87): " + [ v.constructor.name ]);
      };
      var handleQuery = function (v) {
          if (v instanceof NewPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateSelectingPlayer(function (st) {
                  return {
                      values: st.values,
                      players: Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(st.players)
                  };
              })))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Nothing.value);
              });
          };
          if (v instanceof ClearPlayers) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("ClearPlayers: deadPlayers = " + Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.value0))))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateSelectingPlayer(function (st) {
                      return {
                          values: st.values,
                          players: removePlayers(st.players)
                      };
                  })))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Nothing.value);
                  });
          ...
          throw new Error("Failed pattern match at Purlay.Lobby (line 159, column 3 - line 159, column 69): " + [ v.constructor.name ]);
      };
      ...
      var defaultValues = (function () {
          var getDefault = function (v) {
              return new Data_Tuple.Tuple(v.key, v["default"]);
          };
          return Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(getDefault)(valuesSpec));
      })();
      var handleAction = function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.readyState(ws)))(function (rs) {
                          ...
                          if ($45) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateConnecting(function (st) {
                                  return {
                                      urlInput: v.value0,
                                      maybeMsg: new Data_Maybe.Just("Failed to open web-socket at " + v.value0)
                                  };
                              }));
                          };
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Connected(ws)))(function () {
                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new SelectingPlayer({
          ...
          if (v instanceof SetValue) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateSelectingPlayer(function (st) {
                  return {
                      values: Data_Map_Internal.insert(Data_Ord.ordString)(v.value0)(v.value1)(st.values),
                      players: st.players
                  };
              }));
          };
          ...
          throw new Error("Failed pattern match at Purlay.Lobby (line 169, column 18 - line 189, column 44): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var resetAccelY = function (ddy) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Purlay.MovingPoint (line 37, column 1 - line 37, column 52): " + [ ddy.constructor.name, v.constructor.name ]);
      };
  };
  var resetAccelX = function (ddx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Purlay.MovingPoint (line 32, column 1 - line 32, column 52): " + [ ddx.constructor.name, v.constructor.name ]);
      };
  };
  var move = function (v) {
      return function (v1) {
          return {
              ...
              velo: {
                  x: v.slowDownRatio * (v1.velo.x + v1.accell.x),
                  y: v.slowDownRatio * (v1.velo.y + v1.accell.y)
              },
              accell: v1.accell
          };
      };
...
(function($PS) {
          ...
          return function __do() {
              var listener = Web_Event_EventTarget.eventListener(function (ev) {
                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Web_Socket_Event_MessageEvent.fromEvent(ev))(function (msgEvent) {
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(readHelper(Foreign.readString)(Web_Socket_Event_MessageEvent.data_(msgEvent)))(function (msg) {
  ...
  var wsConsumer = function (query) {
      return Control_Coroutine.consumer(Effect_Aff.monadAff)(function (msg) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(query(msg)))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      });
  };
  var setupWSListener = function (ws) {
      return function (query) {
          return Control_Coroutine.runProcess(Effect_Aff.monadRecAff)(Control_Coroutine.connect(Effect_Aff.monadRecAff)(Effect_Aff.parallelAff)(wsProducer(ws))(wsConsumer(query)));
      };
  };
 ...
 */  
  ...
  var EitherHelpers = $PS["EitherHelpers"];
  var Graphics_Canvas = $PS["Graphics.Canvas"];
  ...
  var CanvasQuery = (function () {
      function CanvasQuery(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CanvasQuery.create = function (value0) {
          return function (value1) {
              return new CanvasQuery(value0, value1);
          };
      };
      return CanvasQuery;
  })();
  var HandleLobby = (function () {
      function HandleLobby(value0) {
          this.value0 = value0;
      };
      HandleLobby.create = function (value0) {
          return new HandleLobby(value0);
      };
      return HandleLobby;
  })();
  ...
  var updateGameState = function (fn) {
      return function (v) {
          return {
              m_ws: v.m_ws,
              m_myPlayer: v.m_myPlayer,
              gameState: fn(v.gameState)
          };
      };
  };
  var speedIncrement = 2.0;
  var slowDownRatio = 0.9;
  var sendMyPos = function (v) {
      return function (v1) {
          if (v instanceof Data_Maybe.Just) {
              return Web_Socket_WebSocket.sendString(v.value0)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Purlay_Examples_TigGame_PlayerPiece.encodeJsonPlayerPiece)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "playerPiece";
              }))())(new Data_Symbol.IsSymbol(function () {
                  return "player";
              }))())())(v1)));
  ...
  var sendIt = function (v) {
      return function (v1) {
          if (v instanceof Data_Maybe.Just) {
              return Web_Socket_WebSocket.sendString(v.value0)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "it";
              }))())())({
                  it: v1
              })));
  ...
  var pulseTimeoutMs = 1000.0;
  var pulsePeriodMs = 50.0;

  // adapted from https://milesfrain.github.io/purescript-halogen/guide/04-Lifecycles-Subscriptions.html#implementing-a-timer
  var pulseTimer = function (dictMonadAff) {
      return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(pulsePeriodMs))(function () {
              return Halogen_Query_EventSource.emit(emitter)(Pulse.value);
          }))))(function (fiber) {
  ...
  var messageToAction = function (msg) {
      var parseSetPlayer = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Purlay_Examples_TigGame_PlayerPiece.decodeJsonPlayerPiece)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "playerPiece";
          }))()())(new Data_Symbol.IsSymbol(function () {
              return "player";
          }))()())())(json))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(new SetPlayer(v.player, v.playerPiece));
          });
      };
      var parseSetIt = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "it";
          }))()())())(json))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(new SetIt(v.it));
          });
      };
      var describeErrs = function (s) {
          return EitherHelpers.mapLeft(function (errs) {
      ...
      var describeErr = function (s) {
          return EitherHelpers.mapLeft(function (err) {
      ...
      return Control_Bind.bind(Data_Either.bindEither)(describeErr("Failed to parse message as JSON: ")(Data_Argonaut_Decode_Parser.parseJson(msg)))(function (json) {
          return describeErrs("Failed to decode JSON:\x0a")(EitherHelpers.altMergeLefts(parseSetPlayer(json))(parseSetIt(json)));
      });
  };
  var maxY = 800.0;
  var maxX = 800.0;
  ...
  var initialGameState = {
      it: 0,
      itActive: true,
      playersData: Data_Map_Internal.empty
  };
  var initialState = {
      m_ws: Data_Maybe.Nothing.value,
      m_myPlayer: Data_Maybe.Nothing.value,
      gameState: initialGameState
  };
  var getCollision = function (player1) {
      return function (playerPiece1) {
          return function (playersData) {
              var removeJust = function (v) {
                  if (v instanceof Data_Maybe.Just && v.value0.value1 instanceof Data_Maybe.Just) {
                      return new Data_Maybe.Just(new Data_Tuple.Tuple(v.value0.value0, v.value0.value1.value0));
                  };
                  return Data_Maybe.Nothing.value;
              };
              return removeJust(Data_Foldable.find(Data_List_Lazy_Types.foldableList)(function (v) {
                  return Data_Maybe.isJust(v.value1);
              })(Data_Map_Internal.toUnfoldable(Data_List_Lazy_Types.unfoldableList)(Data_Functor.map(Data_Map_Internal.functorMap)(function (v) {
                  return Purlay_GameObject.bounceOff(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece)(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece)(v.playerPiece)(playerPiece1);
              })(Data_Map_Internal.filterKeys(Data_Ord.ordInt)(function (v) {
                  return v !== player1;
              })(playersData)))));
          };
      };
 ...
 */  
  var canvasComponent = function (dictMonadAff) {
      return function (myPlayer) {
          var drawOnCanvas = function (state) {
              var drawPlayers = function (context) {
                  var drawPlayer = function (v) {
                      var is_me = v.value0 === myPlayer;
                      var is_it = v.value0 === state.it;
                      var playerStyle = (function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 259, column 13 - line 262, column 36): " + [  ]);
                      })();
                      return Purlay_Drawable.draw(Purlay_Examples_TigGame_PlayerPiece.drawablePlayerPiece)(v.value1.playerPiece)({
                          context: context,
                          style: playerStyle
                      });
                  };
                  ...
                  return Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(function __do() {
                      drawBoard();
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Lazy_Types.foldableList)(drawPlayer)(Data_Map_Internal.toUnfoldable(Data_List_Lazy_Types.unfoldableList)(state.playersData))();
                  });
              };
              return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "state";
              }))(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "playersData";
              }))(Data_Map_Internal.eqMap(Data_Eq.eqInt)(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "time";
              }))(Data_DateTime_Instant.eqDateTime))()(new Data_Symbol.IsSymbol(function () {
                  return "playerPiece";
              }))(Purlay_Examples_TigGame_PlayerPiece.eqPlayerPiece)))))()(new Data_Symbol.IsSymbol(function () {
                  return "itActive";
              }))(Data_Eq.eqBoolean))()(new Data_Symbol.IsSymbol(function () {
                  return "it";
              }))(Data_Eq.eqInt)))))({
                  state: state
              })(Halogen_Hooks.useTickEffect)(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasElementById("canvas")))(function (mcanvas) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Data_Traversable.sequence(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Data_Functor.map(Data_Maybe.functorMaybe)(Graphics_Canvas.getContext2D)(mcanvas))))(function (mcontext) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Data_Foldable.traverse_(Halogen_Hooks_HookM.applicativeHookM)(Data_Foldable.foldableMaybe)(drawPlayers)(mcontext))(function () {
                          return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                      });
                  });
              })))(function () {
                  return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Data_Unit.unit);
              });
          };
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(initialGameState))(function (v2) {
                      return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useQuery(v.queryToken)(function (v3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.modify_(v2.value1)(Data_Function["const"](v3.value0)))(function () {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                          });
                      }))(function () {
                          return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(drawOnCanvas(v2.value0))(function () {
                              return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("canvas"), Halogen_HTML_Properties.width(Data_Int.ceil(maxX)), Halogen_HTML_Properties.height(Data_Int.ceil(maxY)) ]));
                          });
                      });
                  });
              };
  ...
  var passStateToCanvas = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      if (v.m_myPlayer instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
      };
      if (v.m_myPlayer instanceof Data_Maybe.Just) {
          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
              return "canvas";
          }))(Data_Ord.ordInt)(_canvas)(1)(Halogen_Query.tell(CanvasQuery.create(v.gameState))));
      };
      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 212, column 3 - line 215, column 64): " + [ v.m_myPlayer.constructor.name ]);
  });
      ...
      var render = function (v) {
          if (v.m_myPlayer instanceof Data_Maybe.Nothing) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "lobby";
              }))(Data_Ord.ordInt)(_lobby)(0)(Purlay_Lobby.component(tigLobbySpec))(Data_Unit.unit)(function ($157) {
                  return Data_Maybe.Just.create(HandleLobby.create($157));
              });
          };
          if (v.m_myPlayer instanceof Data_Maybe.Just) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "canvas";
              }))(Data_Ord.ordInt)(_canvas)(1)(canvasComponent(Effect_Aff_Class.monadAffAff)(v.m_myPlayer.value0))(Data_Unit.unit)(Data_Maybe.Just.create);
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 277, column 3 - line 278, column 80): " + [ v.constructor.name ]);
      };
      var olderThan = function (timeCutOff) {
          return function (v) {
              var v1 = Data_DateTime_Instant.unInstant(v.time);
              return v1 < timeCutOff;
          };
      };
      var handleMoveBy = function (moveCenter) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              ...
              if (v.m_myPlayer instanceof Data_Maybe.Just) {
                  var v1 = Data_Map_Internal.lookup(Data_Ord.ordInt)(v.m_myPlayer.value0)(v.gameState.playersData);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      var newPlayerPiece = Purlay_GameObject.updateXYState(Purlay_Examples_TigGame_PlayerPiece.isGameObjectPlayerPiece)(function (r) {
                          return moveCenter(r.xyState);
                      })(v1.value0.playerPiece);
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (st) {
                              return {
                                  it: st.it,
                                  itActive: st.itActive,
                                  playersData: Data_Map_Internal.insert(Data_Ord.ordInt)(v.m_myPlayer.value0)({
                                      playerPiece: newPlayerPiece,
                                      time: time
                                  })(st.playersData)
                              };
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(sendMyPos(v.m_ws)({
                                      player: v.m_myPlayer.value0,
                                      playerPiece: newPlayerPiece
                                  })))(function () {
                                      var v2 = getCollision(v.m_myPlayer.value0)(newPlayerPiece)(v.gameState.playersData);
                                      if (v2 instanceof Data_Maybe.Nothing) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      };
                                      if (v2 instanceof Data_Maybe.Just) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (st) {
                                              return {
                                                  ...
                                                  itActive: st.itActive,
                                                  playersData: Data_Map_Internal.insert(Data_Ord.ordInt)(v.m_myPlayer.value0)({
                                                      playerPiece: v2.value0.value1,
                                                      time: time
                                                  })(st.playersData)
                                              };
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                                                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v.m_myPlayer.value0 === v.gameState.it && v.gameState.itActive)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v3) {
                                                      return {
                                                          it: v2.value0.value0,
                                                          itActive: v3.itActive,
                                                          playersData: v3.playersData
                                                      };
                                                  })))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                                                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(sendIt(v.m_ws)(v2.value0.value0));
                                                      });
                                                  }));
                                              });
                                          });
                                      };
                                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 437, column 13 - line 451, column 52): " + [ v2.constructor.name ]);
                                  });
                              });
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 423, column 9 - line 451, column 52): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 420, column 5 - line 451, column 52): " + [ v.m_myPlayer.constructor.name ]);
          });
      };
      var handleAction = function (v) {
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.Connected) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $115 = {};
                  for (var $116 in st) {
                      if ({}.hasOwnProperty.call(st, $116)) {
                          $115[$116] = st[$116];
                      };
                  };
                  $115.m_ws = new Data_Maybe.Just(v.value0.value0);
                  return $115;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.affEventSource(Effect_Aff_Class.monadAffAff)(function (emitter) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(WSListener.setupWSListener(v.value0.value0)(function (msg) {
                          return Halogen_Query_EventSource.emit(emitter)(new ReceiveMessageFromPeer(msg));
                      })))(function (fiber) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Effect_Aff.killFiber(Effect_Exception.error("Event source finalized"))(fiber));
                      });
                  }))))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(pulseTimer(Effect_Aff_Class.monadAffAff)));
                  });
              });
          };
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.SelectedPlayer) {
              var name = Data_Maybe.fromMaybe("?")(Data_Map_Internal.lookup(Data_Ord.ordString)("name")(v.value0.value1));
              var playerPiece = Purlay_Examples_TigGame_PlayerPiece.newPlayerPiece({
                  xyState: initialMPt(v.value0.value0),
                  name: name,
                  radius: playerRadius
              });
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $120.m_myPlayer = new Data_Maybe.Just(v.value0.value0);
                      $120.gameState = {
                          playersData: Data_Map_Internal.singleton(v.value0.value0)({
                              playerPiece: playerPiece,
                              time: time
                          }),
                          it: initialGameState.it,
                          itActive: initialGameState.itActive
                      };
                      return $120;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Pulse.value))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                  return Halogen_Query_EventSource.eventListenerEventSource(Effect_Aff_Class.monadAffAff)(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                      var $158 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create(sid));
                                      return function ($159) {
                                          return $158(Web_UIEvent_KeyboardEvent.fromEvent($159));
                                      };
                                  })());
                              }))(function () {
                                  return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                      return Halogen_Query_EventSource.eventListenerEventSource(Effect_Aff_Class.monadAffAff)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                          var $160 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create(sid));
                                          return function ($161) {
                                              return $160(Web_UIEvent_KeyboardEvent.fromEvent($161));
                                          };
                                      })());
                                  });
                              });
          ...
          if (v instanceof ReceiveMessageFromPeer) {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 332, column 7 - line 334, column 44): " + [ v1.constructor.name ]);
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (st) {
                      return {
                          it: st.it,
                          itActive: st.itActive,
                          playersData: Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)({
                              playerPiece: v.value1,
                              time: time
                          })(st.playersData)
                      };
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(0)(Halogen_Query.tell(Purlay_Lobby.NewPlayer.create(v.value0)(Data_Map_Internal.singleton("name")(v.value1.name)))));
                      });
                  });
              });
          };
          if (v instanceof SetIt) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v1) {
                  return {
                      it: v.value0,
                      itActive: false,
                      playersData: v1.playersData
                  };
              })))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                          if (v1.m_myPlayer instanceof Data_Maybe.Just && v.value0 === v1.m_myPlayer.value0) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.delay(1000.0)))(function () {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v2) {
                                      return {
                                          it: v2.it,
                                          itActive: true,
                                          playersData: v2.playersData
                                      };
                                  }));
                              });
                          };
          ...
          if (v instanceof HandleKeyDown) {
              ...
              if (v1 === "ArrowLeft") {
                  return handleMoveBy(Purlay_MovingPoint.setAccelX(-speedIncrement));
              };
              if (v1 === "ArrowRight") {
                  return handleMoveBy(Purlay_MovingPoint.setAccelX(speedIncrement));
              };
              if (v1 === "ArrowUp") {
                  return handleMoveBy(Purlay_MovingPoint.setAccelY(-speedIncrement));
              };
              if (v1 === "ArrowDown") {
                  return handleMoveBy(Purlay_MovingPoint.setAccelY(speedIncrement));
              };
          ...
          if (v instanceof HandleKeyUp) {
              var v1 = Web_UIEvent_KeyboardEvent.key(v.value1);
              if (v1 === "ArrowLeft") {
                  return handleMoveBy(Purlay_MovingPoint.resetAccelX(-speedIncrement));
              };
              if (v1 === "ArrowRight") {
                  return handleMoveBy(Purlay_MovingPoint.resetAccelX(speedIncrement));
              };
              if (v1 === "ArrowUp") {
                  return handleMoveBy(Purlay_MovingPoint.resetAccelY(-speedIncrement));
              };
              if (v1 === "ArrowDown") {
                  return handleMoveBy(Purlay_MovingPoint.resetAccelY(speedIncrement));
              };
          ...
          if (v instanceof Pulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  var timeCutOff = v1 - pulseTimeoutMs;
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      var deadPlayers = Data_Map_Internal.filter(Data_Ord.ordInt)(olderThan(timeCutOff))(v2.gameState.playersData);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $145 = Data_Map_Internal.isEmpty(deadPlayers);
                          if ($145) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(0)(Halogen_Query.tell(Purlay_Lobby.ClearPlayers.create(Data_Set.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Map.keys(deadPlayers))))));
                      })())(function () {
                          var playersData2 = Data_Map_Internal.filter(Data_Ord.ordInt)((function () {
                              var $162 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                              var $163 = olderThan(timeCutOff);
                              return function ($164) {
                                  return $162($163($164));
                              };
                          })())(v2.gameState.playersData);
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v3) {
                              return {
                                  it: v3.it,
                                  itActive: v3.itActive,
                              ...
                              if (v2.m_myPlayer instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (v2.m_myPlayer instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleMoveBy((function () {
                                      var $165 = Purlay_MovingPoint.constrainPosWrapAround({
                                          minX: 0.0,
                                          maxX: maxX,
                                          minY: 0.0,
                                          maxY: maxY
                                      });
                                      var $166 = Purlay_MovingPoint.constrainSpeed({
                                          maxSpeed: maxSpeed
                                      });
                                      var $167 = Purlay_MovingPoint.move({
                                      ...
                                      var itGone = !Data_Map_Internal.member(Data_Ord.ordInt)(v2.gameState.it)(playersData2);
                                      var m_minPlayer = Data_Map_Internal.findMin(playersData2);
                                      if (m_minPlayer instanceof Data_Maybe.Just && (itGone && m_minPlayer.value0.key === v2.m_myPlayer.value0)) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v3) {
                                              return {
                                                  it: v2.m_myPlayer.value0,
                                                  itActive: v3.itActive,
                                                  playersData: v3.playersData
                                              };
                                          })))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                                                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(sendIt(v3.m_ws)(v2.m_myPlayer.value0));
                                              });
                                          });
                                      };
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              ...
                              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 393, column 7 - line 411, column 27): " + [ v2.m_myPlayer.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 290, column 18 - line 411, column 27): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (a) {
              return initialState;
  ...
  var mainTigGame = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(rootComponent)(Data_Unit.unit)(body);
  }));
