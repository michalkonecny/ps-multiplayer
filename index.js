...
(function($PS) {
          ...
          return function (v1) {
              return function (context) {
                  ...
                  var playerStyle = (function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 117, column 3 - line 120, column 26): " + [  ]);
                  })();
                  return function __do() {
              ...
              var m_mvshape = function (v1) {
                  ...
                  if (v1 instanceof Purlay_Examples_TigGame_Global.PushStart) {
                      return Data_Maybe.Just.create(Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 142, column 7 - line 146, column 44): " + [ v1.value0.constructor.name ]);
                      })()));
                  };
                  if (v1 instanceof Purlay_Examples_TigGame_Global.PushStop) {
                      return Data_Maybe.Just.create(Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 149, column 7 - line 153, column 46): " + [ v1.value0.constructor.name ]);
                      })()));
                  };
                  if (v1 instanceof Purlay_Examples_TigGame_Global.CheckCollidedWith) {
                      return Purlay_MovingShape.bounceOff(v1.value0)(v.mvshape);
                  };
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 130, column 3 - line 139, column 73): " + [ v1.constructor.name ]);
              };
              return {
  ...
  var $$new = function (v) {
      var playerId = Data_Maybe.maybe(0)(Control_Category.identity(Control_Category.categoryFn))(v.m_playerId);
      var mvshape = {
              ...
              return function (gameObjects) {
                  var findCollision = function ($copy_v) {
                      ...
                      function $tco_loop(v) {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 404, column 3 - line 404, column 35): " + [ v.constructor.name ]);
                      };
                      while (!$tco_done) {
                          $tco_result = $tco_loop($copy_v);
                      };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              if (v.m_connection instanceof Data_Maybe.Just && v.m_myPiece instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 364, column 25 - line 372, column 32): " + [ v1.m_object.constructor.name ]);
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 377, column 9 - line 380, column 72): " + [ m_collisionResult.constructor.name ]);
                  });
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          });
      ...
      var handleAction = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.m_connection instanceof Data_Maybe.Just) {
                          var playerPiece = Purlay_Examples_TigGame_PlayerPiece["new"]({
                              m_playerId: new Data_Maybe.Just(v1.m_connection.value0.my_peerId),
                              name: name
                          });
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $119 = {};
          ...
          if (v instanceof FromCoordinator && v.value0 instanceof Purlay_Coordinator.O_PeersGone) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $147.otherPieces = Data_Array.foldl(Data_Function.flip(Data_Map_Internal["delete"](Data_Ord.ordInt)))(s.otherPieces)(v.value0.value0);
                  return $147;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query.tell()({
          ...
          if (v instanceof SetPlayer) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $158.otherPieces = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(s.otherPieces);
                      return $158;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                          if (v1.m_connection instanceof Data_Maybe.Just && v1.m_myPiece instanceof Data_Maybe.Just) {
