...
(function($PS) {
  ...
  var NewPowerMeasurement = (function () {
      function NewPowerMeasurement(value0) {
          this.value0 = value0;
      };
      NewPowerMeasurement.create = function (value0) {
          return new NewPowerMeasurement(value0);
      };
      return NewPowerMeasurement;
  })();
  ...
  var messageToAction = function (msg) {
      ...
      var parseNewPowerMeasurement = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new NewPowerMeasurement({
                  peerId: v.peerId,
                  power: v.power
              }));
          });
      ...
      var render = function (v) {
          if (v.m_my_info instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "lobby";
              }))(Data_Ord.ordInt)(_lobby)(111)(Purlay_Lobby.component(valuesSpec))(Data_Unit.unit)(function ($131) {
                  return Data_Maybe.Just.create(HandleLobby.create($131));
          ...
          if (v.m_my_info instanceof Data_Maybe.Just) {
              return Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "peerId";
              }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt)))(v.m_my_info.value0) + ("; " + (Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.peers_order) + ("; " + (Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_DateTime_Instant.showInstant))(v.peers_alive) + ("; " + Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_Show.showNumber))(v.peers_power)))))));
          };
          throw new Error("Failed pattern match at Purlay.Coordinator (line 166, column 3 - line 171, column 8): " + [ v.constructor.name ]);
      };
      var handleAction = function (v) {
          if (v instanceof ReceiveMessageFromPeer) {
              ...
              throw new Error("Failed pattern match at Purlay.Coordinator (line 178, column 7 - line 180, column 44): " + [ v1.constructor.name ]);
          };
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.O_Connected) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $67.m_ws = new Data_Maybe.Just(v.value0.value0);
                  return $67;
              }))(function () {
          ...
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.O_SelectedPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $72.m_my_info = new Data_Maybe.Just({
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(measurePower))(function (power) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(broadcastToPeers(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                      ...
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                          ...
                                          $80.peers_power = peers_power2;
                                          return $80;
                                      });
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at Purlay.Coordinator (line 208, column 7 - line 214, column 55): " + [ v1.m_my_info.constructor.name ]);
                      })())(function () {
          ...
          if (v instanceof NewPowerMeasurement) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $102.peers_power = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0.peerId)(v.value0.power)(s.peers_power);
                  return $102;
              });
          };
          ...
          if (v instanceof Pulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $114 = Data_Map_Internal.isEmpty(deadPlayers);
                          if ($114) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new O_RemovePeers(deadPlayersArray)))(function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $115.peers_alive = peers_alive2;
                                      $115.peers_power = peers_power2;
                                      return $115;
                                  }))(function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Coordinator (line 264, column 7 - line 267, column 61): " + [ v1.m_my_info.constructor.name ]);
                      });
                  });
              });
          };
          if (v instanceof PeerPulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $127.peers_alive = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(time)(s.peers_alive);
                      return $127;
                  });
              });
          };
