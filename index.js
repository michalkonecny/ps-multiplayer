 ...
 */  
  ...
  exports["slowDownThreshold"] = slowDownThreshold;
              ...
              var m_mvshape = function (v1) {
                  if (v1 instanceof FrameTick) {
                      var mvshape = Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          ...
                          var $41 = Purlay_MovingPoint.move({
                              ...
                              slowDownThreshold: Purlay_Examples_TigGame_Global.slowDownThreshold
                          });
                          return function ($42) {
                              return $39($40($41($42)));
                          };
                      })());
                      var $26 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "velo";
                  ...
                  if (v1 instanceof PushStart) {
                      return Data_Maybe.Just.create(Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 125, column 7 - line 129, column 44): " + [ v1.value0.constructor.name ]);
                      })()));
                  };
                  if (v1 instanceof PushStop) {
                      return Data_Maybe.Just.create(Data_Function.flip(Purlay_MovingShape.updateXYState)(v.mvshape)((function () {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 132, column 7 - line 136, column 46): " + [ v1.value0.constructor.name ]);
                      })()));
                  };
                  if (v1 instanceof CheckCollidedWith) {
                      return Purlay_MovingShape.bounceOff((Purlay_GameObject.unGO(v1.value0)).movingShape)(v.mvshape);
                  };
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame.PlayerPiece (line 113, column 3 - line 122, column 73): " + [ v1.constructor.name ]);
              };
              return {
              ...
              return function (gameObjects) {
                  var findCollision = function ($copy_v) {
                      ...
                      function $tco_loop(v) {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 349, column 3 - line 349, column 35): " + [ v.constructor.name ]);
                      };
                      while (!$tco_done) {
                          $tco_result = $tco_loop($copy_v);
                      };
      ...
      var render = function (v) {
          if (v.m_connection instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "wsconnector";
              }))(Data_Ord.ordInt)(_wsconnector)(_wsconnectorN)(Purlay_WSConnector.component)(Data_Unit.unit)(function ($187) {
                  return Data_Maybe.Just.create(FromWSConnector.create($187));
              }))));
          };
          if (v.m_connection instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(FromCoordinator.create($188));
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.br_))(function () {
                      if (v.m_myPiece instanceof Data_Maybe.Nothing) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                              ...
                              return Data_Maybe.Just.create(FromLobby.create($189));
                          }));
                      };
                      if (v.m_myPiece instanceof Data_Maybe.Just) {
                          return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return function (playerPiece$prime) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $79.m_myPiece = new Data_Maybe.Just(playerPiece$prime);
                          return $79;
                      }))(function () {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v1.m_object instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $90.m_myPiece = new Data_Maybe.Just(v1.m_object.value0);
                              return $90;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 309, column 25 - line 317, column 32): " + [ v1.m_object.constructor.name ]);
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 322, column 9 - line 325, column 72): " + [ m_collisionResult.constructor.name ]);
                  });
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          });
      ...
      var handleAction = function (v) {
          if (v instanceof FromWSConnector) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Random.randomInt(0)(2000000000)))(function (my_peerId) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $107.m_connection = new Data_Maybe.Just({
                          ws: v.value0.value0,
                          my_peerId: my_peerId
                      });
                      return $107;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.m_connection instanceof Data_Maybe.Just) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $114.m_myPiece = new Data_Maybe.Just(playerPiece);
                              return $114;
                          }))(function () {
          ...
          if (v instanceof FromCoordinator && v.value0 instanceof Purlay_Coordinator.O_PeersGone) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $134.otherPieces = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Function.flip(Data_Map_Internal["delete"](Data_Ord.ordInt)))(s.otherPieces)(v.value0.value0);
                  return $134;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
          ...
          if (v instanceof FromCoordinator && v.value0 instanceof Purlay_Coordinator.O_StateChanges) {
              ...
              throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 225, column 7 - line 227, column 62): " + [ v1.constructor.name ]);
          };
          if (v instanceof SetPlayer) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $145.otherPieces = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(s.otherPieces);
                      return $145;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateCanvas)(function () {
                          if (v1.m_connection instanceof Data_Maybe.Just && v1.m_myPiece instanceof Data_Maybe.Just) {
          ...
          if (v instanceof FrameTick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 285, column 7 - line 300, column 46): " + [ v1.m_connection.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 185, column 18 - line 300, column 46): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (a) {
