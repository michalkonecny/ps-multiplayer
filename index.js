 ...
 */  
  ...
  var defaultWSURL = "ws://localhost:3000";
  var component = function (valuesSpec) {
      var render = function (v) {
          if (v instanceof Connecting) {
              var enterWSURL = Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.div_(Control_SequenceBuildMonad.sb(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.span_(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Core.text("Enter broadcast server web-socket URL: ws://")))(function () {
                  return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.input(Control_SequenceBuildMonad.sb(Control_Bind.discard(Control_Bind.discardUnit)(Control_SequenceBuildMonad.sequenceBind(Data_Monoid.monoidArray))(Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Properties.value(Data_String_CodePoints.drop(5)(defaultWSURL))))(function () {
                      return Control_SequenceBuildMonad.ae(Control_Applicative.applicativeArray)(Halogen_HTML_Events.onValueChange(function ($49) {
          ...
          throw new Error("Failed pattern match at Lobby (line 105, column 3 - line 116, column 87): " + [ v.constructor.name ]);
      };
      var handleQuery = function (v) {
          ...
          throw new Error("Failed pattern match at Lobby (line 157, column 3 - line 157, column 69): " + [ v.constructor.name ]);
      };
      ...
      var handleAction = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.create(v.value0)([  ])))(function (ws) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.delay(100.0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.readyState(ws)))(function (rs) {
                          var $43 = Data_Eq.notEq(Web_Socket_ReadyState.eqReadyState)(rs)(Web_Socket_ReadyState.Open.value);
                          if ($43) {
          ...
          throw new Error("Failed pattern match at Lobby (line 167, column 18 - line 182, column 44): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              initialize: new Data_Maybe.Just(new SetWSURL(defaultWSURL)),
 ...
 */  
  "use strict";
  $PS["MovingBall"] = $PS["MovingBall"] || {};
  var exports = $PS["MovingBall"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Int = $PS["Data.Int"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var relativeTo = function (dictApplicative) {
      return function (v) {
          return function (ball2) {
              return function (ballFn) {
                  var translateThere = function (v1) {
                      return {
                          center: {
                              pos: {
                                  x: v1.center.pos.x - v.center.pos.x,
                                  y: v1.center.pos.y - v.center.pos.y
                              },
                              velo: {
                                  x: v1.center.velo.x - v.center.velo.x,
                                  y: v1.center.velo.y - v.center.velo.y
                              },
                              accell: v1.center.accell
                          },
                          name: v1.name,
                          radius: v1.radius
                      };
                  ...
                  return Data_Functor.map((dictApplicative.Apply0()).Functor0())(translateBack)(ballFn(translateThere(ball2)));
              };
          };
      };
  };
  var drawBall = function (context) {
      return function (style) {
          return function (v) {
              var textSize = Data_Int.round(1.6 * v.radius);
              return function __do() {
                  Graphics_Canvas.setFillStyle(context)(style)();
                  ...
                  return Graphics_Canvas.fillText(context)(v.name)(v.center.pos.x)(v.center.pos.y + 0.6 * v.radius)();
              };
          };
      };
  };
  var ballsAreTouching = function (v) {
      return function (v1) {
          var sqr = function (a) {
              return a * a;
          };
          return sqr(v.center.pos.x - v1.center.pos.x) + sqr(v.center.pos.y - v1.center.pos.y) <= sqr(v.radius + v1.radius);
      };
  };
  var ballBounceOffBall = function (v) {
      return function (v1) {
          if (ballsAreTouching(v)(v1)) {
              var relCollision = function (v2) {
                
                  // velocity towards other ball stationary at (0,0):
  var v3 = -(v2.center.pos.y * v2.center.velo.y + v2.center.pos.x * v2.center.velo.x) / (v2.center.pos.x * v2.center.pos.x + v2.center.pos.y * v2.center.pos.y);
                  var $66 = v3 <= 0.0;
                  if ($66) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Maybe.Just.create({
                      center: {
                          velo: {
                              x: v2.center.velo.x + (v3 * v2.center.pos.x) / 2.0,
                              y: v2.center.velo.y + (v3 * v2.center.pos.y) / 2.0
                          },
                          pos: v2.center.pos,
                          accell: v2.center.accell
                      },
                      name: v2.name,
                      radius: v2.radius
                  });
              };
              return relativeTo(Data_Maybe.applicativeMaybe)(v)(v1)(relCollision);
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at MovingBall (line 34, column 1 - line 34, column 66): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  exports["ballBounceOffBall"] = ballBounceOffBall;
  exports["drawBall"] = drawBall;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["MovingPoint"] = $PS["MovingPoint"] || {};
  var exports = $PS["MovingPoint"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Int = $PS["Data.Int"];
  var Data_Ord = $PS["Data.Ord"];                
  ...
  var resetAccelY = function (ddy) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at MovingPoint (line 33, column 1 - line 33, column 52): " + [ ddy.constructor.name, v.constructor.name ]);
      };
  };
  var resetAccelX = function (ddx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at MovingPoint (line 28, column 1 - line 28, column 52): " + [ ddx.constructor.name, v.constructor.name ]);
      };
  };
  var move = function (slowDownRatio) {
      return function (v) {
          return {
              pos: {
                  x: v.pos.x + v.velo.x,
              ...
              velo: {
                  x: slowDownRatio * (v.velo.x + v.accell.x),
                  y: slowDownRatio * (v.velo.y + v.accell.y)
              },
              accell: v.accell
          };
      };
  };
  var constrainSpeed = function (maxSpeed) {
      return function (v) {
          return {
              pos: v.pos,
              velo: {
                  x: Data_Ord.max(Data_Ord.ordNumber)(Data_Ord.min(Data_Ord.ordNumber)(v.velo.x)(maxSpeed))(-maxSpeed),
                  y: Data_Ord.max(Data_Ord.ordNumber)(Data_Ord.min(Data_Ord.ordNumber)(v.velo.y)(maxSpeed))(-maxSpeed)
              },
              accell: v.accell
          };
      };
  };
  var constrainLocation = function (maxX) {
  ...
  exports["constrainLocation"] = constrainLocation;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TigGameSmooth"] = $PS["TigGameSmooth"] || {};
  var exports = $PS["TigGameSmooth"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Rec_Class = $PS["Control.Monad.Rec.Class"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var Lobby = $PS["Lobby"];
  var MovingBall = $PS["MovingBall"];
  var MovingPoint = $PS["MovingPoint"];
  ...
  var sendMyPos = function (v) {
      return function (v1) {
          if (v instanceof Data_Maybe.Just) {
              return Web_Socket_WebSocket.sendString(v.value0)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "y";
                  ...
                  return "accell";
              }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "radius";
              }))())(new Data_Symbol.IsSymbol(function () {
                  return "name";
              }))())(new Data_Symbol.IsSymbol(function () {
                  return "center";
              }))())())(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "player";
              }))())(new Data_Symbol.IsSymbol(function () {
                  return "movingBall";
              }))())())(v1)));
  ...
  var messageToAction = function (msg) {
      var parseSetPlayer = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return "accell";
          }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "radius";
          }))()())(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()())(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new SetPlayer(v.player, v.movingBall));
          });
      };
  ...
  var initialMPt = function (player) {
      ...
      return MovingPoint.constrainLocation(maxX)(maxY)({
          pos: {
              x: playerN * 107.0,
              y: playerN * 107.0
          },
      ...
      return function (movingBall1) {
          return function (playersData) {
              ...
              return removeJust(Data_Foldable.find(Data_List_Lazy_Types.foldableList)(function (v) {
                  ...
                  return MovingBall.ballBounceOffBall(v.movingBall)(movingBall1);
              ...
              var drawPlayers = function (context) {
                  var drawPlayer = function (v) {
                      ...
                      var playerStyle = (function () {
                          ...
                          throw new Error("Failed pattern match at TigGameSmooth (line 256, column 13 - line 259, column 36): " + [  ]);
                      })();
                      return MovingBall.drawBall(context)(playerStyle)(v.value1.movingBall);
                  };
  ...
  var passStateToCanvas = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      ...
      throw new Error("Failed pattern match at TigGameSmooth (line 209, column 3 - line 212, column 64): " + [ v.m_myPlayer.constructor.name ]);
  });
      ...
      var render = function (v) {
          if (v.m_myPlayer instanceof Data_Maybe.Nothing) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "lobby";
              }))(Data_Ord.ordInt)(_lobby)(0)(Lobby.component(tigLobbySpec))(Data_Unit.unit)(function ($153) {
                  return Data_Maybe.Just.create(HandleLobby.create($153));
              });
          };
          if (v.m_myPlayer instanceof Data_Maybe.Just) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          ...
          throw new Error("Failed pattern match at TigGameSmooth (line 274, column 3 - line 275, column 80): " + [ v.constructor.name ]);
      };
      ...
      var handleMoveBy = function (moveCenter) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              ...
              if (v.m_myPlayer instanceof Data_Maybe.Just) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      var newMovingBall = {
                          center: moveCenter(v1.value0.movingBall.center),
                          name: v1.value0.movingBall.name,
                          radius: v1.value0.movingBall.radius
                      };
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(sendMyPos(v.m_ws)({
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          var v2 = getCollision(v.m_myPlayer.value0)(newMovingBall)(v.gameState.playersData);
                                          if (v2 instanceof Data_Maybe.Nothing) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          };
                                          if (v2 instanceof Data_Maybe.Just) {
                                          ...
                                          throw new Error("Failed pattern match at TigGameSmooth (line 427, column 13 - line 441, column 52): " + [ v2.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v.m_myPlayer.value0 === v.gameState.it && (!v.gameState.itActive && Data_Maybe.isNothing(getCollision(v.m_myPlayer.value0)(newMovingBall)(v.gameState.playersData))))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v2) {
                                              return {
                                                  it: v2.it,
                                                  itActive: true,
                  ...
                  throw new Error("Failed pattern match at TigGameSmooth (line 413, column 9 - line 446, column 32): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at TigGameSmooth (line 410, column 5 - line 446, column 32): " + [ v.m_myPlayer.constructor.name ]);
          });
      };
      var handleAction = function (v) {
          if (v instanceof HandleLobby && v.value0 instanceof Lobby.Connected) {
          ...
          if (v instanceof HandleLobby && v.value0 instanceof Lobby.SelectedPlayer) {
              var name = Data_Maybe.fromMaybe("?")(Data_Map_Internal.lookup(Data_Ord.ordString)("name")(v.value0.value1));
              var movingBall = {
                  center: initialMPt(v.value0.value0),
                  name: name,
                  radius: playerRadius
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                  return Halogen_Query_EventSource.eventListenerEventSource(Effect_Aff_Class.monadAffAff)(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                      var $154 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create(sid));
                                      return function ($155) {
                                          return $154(Web_UIEvent_KeyboardEvent.fromEvent($155));
                                      };
                                  })());
                              }))(function () {
                                  return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                      return Halogen_Query_EventSource.eventListenerEventSource(Effect_Aff_Class.monadAffAff)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                          var $156 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create(sid));
                                          return function ($157) {
                                              return $156(Web_UIEvent_KeyboardEvent.fromEvent($157));
                                          };
                                      })());
                                  });
                              });
          ...
          if (v instanceof ReceiveMessageFromPeer) {
              ...
              throw new Error("Failed pattern match at TigGameSmooth (line 329, column 7 - line 331, column 44): " + [ v1.constructor.name ]);
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (st) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(passStateToCanvas)(function () {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(0)(Halogen_Query.tell(Lobby.NewPlayer.create(v.value0)(Data_Map_Internal.singleton("name")(v.value1.name)))));
                      });
                  });
              });
          };
          if (v instanceof SetIt) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v1) {
                  return {
                      it: v.value0,
                      itActive: false,
          ...
          if (v instanceof HandleKeyDown) {
              ...
              if (v1 === "ArrowLeft") {
                  return handleMoveBy(MovingPoint.setAccelX(-speedIncrement));
              };
              if (v1 === "ArrowRight") {
                  return handleMoveBy(MovingPoint.setAccelX(speedIncrement));
              };
              if (v1 === "ArrowUp") {
                  return handleMoveBy(MovingPoint.setAccelY(-speedIncrement));
              };
              if (v1 === "ArrowDown") {
                  return handleMoveBy(MovingPoint.setAccelY(speedIncrement));
              };
          ...
          if (v instanceof HandleKeyUp) {
              var v1 = Web_UIEvent_KeyboardEvent.key(v.value1);
              if (v1 === "ArrowLeft") {
                  return handleMoveBy(MovingPoint.resetAccelX(-speedIncrement));
              };
              if (v1 === "ArrowRight") {
                  return handleMoveBy(MovingPoint.resetAccelX(speedIncrement));
              };
              if (v1 === "ArrowUp") {
                  return handleMoveBy(MovingPoint.resetAccelY(-speedIncrement));
              };
              if (v1 === "ArrowDown") {
                  return handleMoveBy(MovingPoint.resetAccelY(speedIncrement));
              };
          ...
          if (v instanceof Pulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $141 = Data_Map_Internal.isEmpty(deadPlayers);
                          if ($141) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(0)(Halogen_Query.tell(Lobby.ClearPlayers.create(Data_Set.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Map.keys(deadPlayers))))));
                      })())(function () {
                          var playersData2 = Data_Map_Internal.filter(Data_Ord.ordInt)((function () {
                              var $158 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                              var $159 = olderThan(timeCutOff);
                              return function ($160) {
                                  return $158($159($160));
                              };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateGameState(function (v3) {
                              ...
                              if (v2.m_myPlayer instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleMoveBy((function () {
                                      var $161 = MovingPoint.constrainLocation(maxX)(maxY);
                                      var $162 = MovingPoint.constrainSpeed(maxSpeed);
                                      var $163 = MovingPoint.move(slowDownRatio);
                                      return function ($164) {
                              ...
                              throw new Error("Failed pattern match at TigGameSmooth (line 383, column 7 - line 401, column 27): " + [ v2.m_myPlayer.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at TigGameSmooth (line 287, column 18 - line 401, column 27): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (a) {
              return initialState;
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var TigGameSmooth = $PS["TigGameSmooth"];                
  var main = TigGameSmooth.mainTigGame;
  exports["main"] = main;
})(PS);
PS["Main"].main();