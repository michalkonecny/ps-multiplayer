      ...
      var handleAction = function (v) {
          ...
          if (v instanceof SetWSURL) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.attempt(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_Socket_WebSocket.create(v.value0)([  ])))))(function (ws_or_error) {
                  ...
                  throw new Error("Failed pattern match at Purlay.WSConnector (line 89, column 7 - line 96, column 42): " + [ ws_or_error.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Purlay.WSConnector (line 75, column 18 - line 96, column 42): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
              ...
              return function (gameObjects) {
                  var findCollision = function ($copy_v) {
                      ...
                      function $tco_loop(v) {
                          ...
                          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 341, column 3 - line 341, column 35): " + [ v.constructor.name ]);
                      };
                      while (!$tco_done) {
                          $tco_result = $tco_loop($copy_v);
                      };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              if (v.m_connection instanceof Data_Maybe.Just && v.m_myPiece instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 301, column 25 - line 309, column 32): " + [ v1.m_object.constructor.name ]);
                      ...
                      throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 314, column 9 - line 317, column 72): " + [ m_collisionResult.constructor.name ]);
                  });
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          });
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof FrameTick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 277, column 7 - line 292, column 46): " + [ v1.m_connection.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 177, column 18 - line 292, column 46): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: function (v) {
