 ...
 */  
  ...
  var O_SelectedPlayer = (function () {
      function O_SelectedPlayer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      O_SelectedPlayer.create = function (value0) {
          return function (value1) {
              return new O_SelectedPlayer(value0, value1);
          };
      };
      return O_SelectedPlayer;
  })();
  ...
  var component = function (valuesSpec) {
      ...
      var handleAction = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.create(v.value0)([  ])))(function (ws) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Aff.delay(100.0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Socket_WebSocket.readyState(ws)))(function (rs) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new O_Connected(ws)))(function () {
          ...
          if (v instanceof SelectPlayer) {
              return Halogen_Query_HalogenM.raise(new O_SelectedPlayer(v.value0, v.value1));
          };
          throw new Error("Failed pattern match at Purlay.Lobby (line 169, column 18 - line 189, column 46): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
  ...
  exports["O_Connected"] = O_Connected;
  exports["O_SelectedPlayer"] = O_SelectedPlayer;
  exports["component"] = component;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
...
(function($PS) {
  ...
  var Web_Socket_WebSocket = $PS["Web.Socket.WebSocket"];
  var O_Started = (function () {
      function O_Started(value0) {
          this.value0 = value0;
      };
      O_Started.create = function (value0) {
          return new O_Started(value0);
      };
      return O_Started;
  })();
  var O_RemovePeers = (function () {
      function O_RemovePeers(value0) {
          this.value0 = value0;
      };
      O_RemovePeers.create = function (value0) {
          return new O_RemovePeers(value0);
      };
      return O_RemovePeers;
  })();
  ...
  var PeerPulse = (function () {
      function PeerPulse(value0) {
          this.value0 = value0;
      };
      PeerPulse.create = function (value0) {
          return new PeerPulse(value0);
      };
      return PeerPulse;
  })();
  var NewPeersOrder = (function () {
      function NewPeersOrder(value0) {
          this.value0 = value0;
      };
      NewPeersOrder.create = function (value0) {
          return new NewPeersOrder(value0);
      };
      return NewPeersOrder;
  })();
  var NewPowerMeasurementAndValues = (function () {
      function NewPowerMeasurementAndValues(value0) {
          this.value0 = value0;
      };
      NewPowerMeasurementAndValues.create = function (value0) {
          return new NewPowerMeasurementAndValues(value0);
      };
      return NewPowerMeasurementAndValues;
  })();
  var StateChanges = (function () {
      function StateChanges(value0) {
          this.value0 = value0;
      };
      StateChanges.create = function (value0) {
          return new StateChanges(value0);
      };
      return StateChanges;
  })();
 ...
 */  
  ...
  var periodicEmitter = function (name) {
      return function (periodMs) {
          return function (action) {
              return Halogen_Query_EventSource.affEventSource(Effect_Aff_Class.monadAffAff)(function (emitter) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("starting periodicEmmitter " + name)))(function () {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(periodMs))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("emitting on " + name)))(function () {
  ...
  var messageToAction = function (msg) {
      var parseStateChanges = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonJson)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new StateChanges(v.changes));
          });
      };
      var parsePeerPulse = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new PeerPulse(v.pulse));
          });
      };
      var parseNewPowerMeasurement = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonNumber)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeMap(Data_Ord.ordString)(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "values";
          }))()())(new Data_Symbol.IsSymbol(function () {
              return "power";
          }))()())(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new NewPowerMeasurementAndValues({
                  peerId: v.peerId,
                  power: v.power,
                  values: v.values
              }));
      ...
      var parseNewPeerOrder = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new NewPeersOrder(v.peers_order));
          });
      };
      ...
      return Control_Bind.bind(Data_Either.bindEither)(describeErr("Failed to parse message as JSON: ")(Data_Argonaut_Decode_Parser.parseJson(msg)))(function (json) {
          return describeErrs("Failed to decode JSON:\x0a")(Purlay_EitherHelpers.altMergeLeftsAdd(Purlay_EitherHelpers.altMergeLeftsAdd(Purlay_EitherHelpers.altMergeLefts(parsePeerPulse(json))(parseStateChanges(json)))(parseNewPeerOrder(json)))(parseNewPowerMeasurement(json)));
      });
  };
  ...
  var initialState = {
      ...
      m_my_info: Data_Maybe.Nothing.value,
      peers_order: [  ],
      peers_alive: Data_Map_Internal.empty,
      peers_power: Data_Map_Internal.empty,
      peers_values: Data_Map_Internal.empty
  };
  var i_am_leader = function (v) {
      if (v.m_my_info instanceof Data_Maybe.Just) {
          var v1 = Data_Array.head(v.peers_order);
          if (v1 instanceof Data_Maybe.Just) {
              return v.m_my_info.value0.peerId === v1.value0;
          };
          return false;
      };
      return false;
  ...
  var broadcastToPeers = function (dictEncodeJson) {
      return function (v) {
          return function (v1) {
              if (v instanceof Data_Maybe.Just) {
                  return Web_Socket_WebSocket.sendString(v.value0)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(dictEncodeJson)(v1)));
              };
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
      };
      ...
      var render = function (v) {
          if (v.m_my_info instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "lobby";
              }))(Data_Ord.ordInt)(_lobby)(111)(Purlay_Lobby.component(valuesSpec))(Data_Unit.unit)(function ($134) {
                  return Data_Maybe.Just.create(HandleLobby.create($134));
              }), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.peers_order) + ("; " + (Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_DateTime_Instant.showInstant))(v.peers_alive) + ("; " + Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_Show.showNumber))(v.peers_power))))) ]);
          };
          if (v.m_my_info instanceof Data_Maybe.Just) {
              return Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "peerId";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "values";
              }))(Data_Show.showRecordFieldsNil)(Data_Map_Internal.showMap(Data_Show.showString)(Data_Show.showString)))(Data_Show.showInt)))(v.m_my_info.value0) + ("; " + (Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.peers_order) + ("; " + (Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_DateTime_Instant.showInstant))(v.peers_alive) + ("; " + Data_Show.show(Data_Map_Internal.showMap(Data_Show.showInt)(Data_Show.showNumber))(v.peers_power)))))));
          };
          throw new Error("Failed pattern match at Purlay.Coordinator (line 169, column 3 - line 174, column 8): " + [ v.constructor.name ]);
      };
      var handleAction = function (v) {
          if (v instanceof ReceiveMessageFromPeer) {
              ...
              throw new Error("Failed pattern match at Purlay.Coordinator (line 181, column 7 - line 183, column 44): " + [ v1.constructor.name ]);
          };
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.O_Connected) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $68.m_ws = new Data_Maybe.Just(v.value0.value0);
                  return $68;
              }))(function () {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.affEventSource(Effect_Aff_Class.monadAffAff)(function (emitter) {
          ...
          if (v instanceof HandleLobby && v.value0 instanceof Purlay_Lobby.O_SelectedPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $73.m_my_info = new Data_Maybe.Just({
                      peerId: v.value0.value0,
                      values: v.value0.value1
                  });
                  return $73;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new O_Started({
                      my_id: v.value0.value0,
                      lobby_values: v.value0.value1
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(periodicEmitter("Pulse")(pulsePeriod_ms)(Pulse.value))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(periodicEmitter("MeasurePower")(checkPowerPeriod_ms)(MeasurePower.value))))(function () {
          ...
          if (v instanceof NewPowerMeasurementAndValues) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $104.peers_power = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0.peerId)(v.value0.power)(s.peers_power);
                  $104.peers_values = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0.peerId)(v.value0.values)(s.peers_values);
                  return $104;
              }))(function () {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "lobby";
                  }))(Data_Ord.ordInt)(_lobby)(111)(Halogen_Query.tell(Purlay_Lobby.Q_NewPlayer.create(v.value0.peerId)(v.value0.values))));
              });
          };
          if (v instanceof NewPeersOrder) {
          ...
          if (v instanceof Pulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $117 = Data_Map_Internal.isEmpty(deadPlayers);
                          if ($117) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "lobby";
                          }))(Data_Ord.ordInt)(_lobby)(111)(Halogen_Query.tell(Purlay_Lobby.Q_ClearPlayers.create(deadPlayersArray)))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new O_RemovePeers(deadPlayersArray)))(function () {
                                  var peers_order2 = Data_Array.filter(function (k) {
                                      return Data_Map_Internal.member(Data_Ord.ordInt)(k)(deadPlayers);
                                  })(v1.peers_order);
                                  var peers_alive2 = Data_Map_Internal.filterKeys(Data_Ord.ordInt)(function (k) {
                                      return Data_Map_Internal.member(Data_Ord.ordInt)(k)(deadPlayers);
                                  })(v1.peers_alive);
                                  var peers_power2 = Data_Map_Internal.filterKeys(Data_Ord.ordInt)(function (k) {
                                      return Data_Map_Internal.member(Data_Ord.ordInt)(k)(deadPlayers);
                                  })(v1.peers_power);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $118.peers_alive = peers_alive2;
                                      $118.peers_power = peers_power2;
                                      return $118;
                                  }))(function () {
                          ...
                          if (v1.m_my_info instanceof Data_Maybe.Just) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(broadcastToPeers(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                  ...
                                  pulse: v1.m_my_info.value0.peerId
                              }));
                          };
                          throw new Error("Failed pattern match at Purlay.Coordinator (line 271, column 7 - line 274, column 61): " + [ v1.m_my_info.constructor.name ]);
                      });
                  });
              });
          };
          if (v instanceof PeerPulse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (time) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $130.peers_alive = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(time)(s.peers_alive);
                      return $130;
                  });
              });
          };
...
(function($PS) {
  ...
  var drawableAnyGameObject = new Purlay_Drawable.Drawable(function (v) {
      return function (v1) {
          return v1(function (dictIsGameObject) {
              return Purlay_Drawable.draw(dictIsGameObject.Drawable1())({
                  peerId: v.peerId,
                  gstate: v.gstate,
                  context: v.context
              });
...
(function($PS) {
  ...
  var initialGameState = {
      m_myPeer: Data_Maybe.Nothing.value,
  ...
  var rootComponent = (function () {
      ...
      var render = function (v) {
          if (v.m_myPeer instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "coordinator";
              }))(Data_Ord.ordInt)(_coordinator)(1)(Purlay_Coordinator.component(tigLobbySpec))(Data_Unit.unit)(function ($27) {
                  return Data_Maybe.Just.create(HandleCoordinator.create($27));
              }) ]);
          };
          if (v.m_myPeer instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "coordinator";
              }))(Data_Ord.ordInt)(_coordinator)(1)(Purlay_Coordinator.component(tigLobbySpec))(Data_Unit.unit)(function ($28) {
                  return Data_Maybe.Just.create(HandleCoordinator.create($28));
              }), Halogen_HTML_Elements.br_, Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "canvas";
              }))(Data_Ord.ordInt)(_canvas)(11)(Purlay_GameCanvas.component(Effect_Aff_Class.monadAffAff)({
                  peerId: v.m_myPeer.value0,
                  initGState: Purlay_Examples_TigGame_GState.initGState,
                  width: maxX,
                  height: maxY
              }))(Data_Unit.unit)(Data_Maybe.Just.create) ]);
          };
          throw new Error("Failed pattern match at Purlay.Examples.TigGame (line 183, column 3 - line 187, column 8): " + [ v.constructor.name ]);
      };
      var handleAction = function (v) {
          if (v instanceof HandleCoordinator && v.value0 instanceof Purlay_Coordinator.O_Started) {
              var name = Data_Maybe.fromMaybe("?")(Data_Map_Internal.lookup(Data_Ord.ordString)("name")(v.value0.value0.lobby_values));
              var playerPiece = Purlay_Examples_TigGame_PlayerPiece.newPlayerPiece({
                  peerId: v.value0.value0.my_id,
                  xyState: initialMPt(v.value0.value0.my_id),
                  name: name,
                  radius: playerRadius
              });
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $20.m_myPeer = new Data_Maybe.Just(v.value0.value0.my_id);
                  $20.m_myPiece = new Data_Maybe.Just(playerPiece);
                  return $20;
              }))(function () {
